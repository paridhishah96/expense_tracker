<template>
  <div class="upload-view">
    <Card class="mb-6">
      ...
      <template #content>
        <p class="mb-4">
          Upload a CSV file from your bank or credit card statement to import expenses.
          The system will attempt to auto-categorize your expenses, but you can modify
          the categories before saving.
        </p>
...
const onFileParsed = (expenses) => {
  console.log("Received parsed expenses in Upload view:", expenses.length);
